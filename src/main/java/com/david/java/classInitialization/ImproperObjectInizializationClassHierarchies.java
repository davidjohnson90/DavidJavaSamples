 ...
 * From a JVM perspective, that implies that a corresponding method A calls
 ...
 * constructor's method. As a result, method A begins with byte code
 * instructions that call method B. However, following that call, method A does
 ...
 * A doesn't need to execute those instructions that correspond to initializers
